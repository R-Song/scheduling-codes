#ifndef _CMPH_CHD_PH_N__
#define _CMPH_CHD_PH_N__

#include "cmph.h"

typedef struct __chd_ph_n_data_t chd_ph_n_data_t;
typedef struct __chd_ph_n_config_data_t chd_ph_n_config_data_t;
